...
namespace Entityframework.LabExercise2.Data
{
    public partial class RecruitmentDbContext : DbContext
    {
        ...
        public RecruitmentDbContext(string connectionString)
        {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("Server=8MMBQG3;Database=Recruitment;User Id=sa;Password=Fr4g4t4cr1s");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Employee>(entity =>
            {
                ...
                entity.HasIndex(e => e.CSocialSecurityNo, "UQ__Employee__6AB6057F2CC05F1C")
                    .IsUnique();
